...
export default function ProductDetails() {
  ...
  const handleCart=(e)=>{
    e.preventDefault()
    if(availableCartItems.findIndex(el=>el.product.id === product.id)<0)
    {
     
    
      const newItem = { quantity:1,product:product.id,user:user.id}  //cart me add krte time hr item ki product id ko save kr lo productId name se , so that use baad me match kraya ja ske 
